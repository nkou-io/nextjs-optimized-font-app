...
function Dashboard() {
    ...
    const fetchStats = async ()=>{
        ...
        try {
            ...
            if (failedRequests.length > 0) {
                ...
                const errorMessage = timeoutErrors > 0 ? `${timeoutErrors} request${timeoutErrors > 1 ? 's' : ''} timed out. Some data may be incomplete.` : `${failedRequests.length} data source${failedRequests.length > 1 ? 's' : ''} failed to load. Some information may be incomplete.`;
            ...
            setStats({
                ...
                revenue: results.transactions.reduce((sum, t)=>sum + (t.amount || 0), 0)
            });
        } catch (error) {
    ...
    useEffect({
        "Dashboard.useEffect": ()=>{
            ...
            const attemptReconnect = {
                "Dashboard.useEffect.attemptReconnect": async ()=>{
            ...
            }["Dashboard.useEffect.attemptReconnect"];
            attemptReconnect();
            return ({
                "Dashboard.useEffect": ()=>{
                    mounted = false;
    ...
    useEffect({
        "Dashboard.useEffect": ()=>{
            ...
            let interval;
            const updateStats = {
                "Dashboard.useEffect.updateStats": async ()=>{
                    if (mounted && isConnected) {
                        await fetchStats();
                    }
                }
            }["Dashboard.useEffect.updateStats"];
            if (isConnected) {
                updateStats();
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                onClick: connectBot,
                                disabled: isLoading,
                                className: `${isConnected ? 'bg-green-600' : 'bg-black'} hover:bg-opacity-90 transition-colors relative`,
                                children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                            isLoadingStats && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LoadingSpinner, {}, void 0, false, {
                                fileName: "[project]/src/components/Dashboard.tsx",
                                lineNumber: 194,
                                columnNumber: 30
                            }, this),
...
_s(Dashboard, "oAQdofMJua0Qel0S0kWgie5OYPs=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=src_f9986994._.js.map